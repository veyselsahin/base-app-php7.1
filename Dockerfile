...
RUN apt install -y php7.1 php7.1-fpm php7.1-cli php7.1-mbstring php7.1-gd php7.1-xml zip unzip php7.1-zip php-curl php7.1-mysql php-mysql php-pear php-dev
